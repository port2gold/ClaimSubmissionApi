...
namespace ClaimSubmissionApi.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalId = table.Column<string>(type: "VARCHAR(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProcedureName = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: true),
                    MedicationName = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: true),
